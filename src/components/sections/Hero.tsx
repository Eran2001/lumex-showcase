...
export const Hero = () => {
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="hero-blob-slow absolute -top-20 -left-20 w-72 h-72 rounded-full bg-primary/20 blur-3xl"
      />
      <div
        aria-hidden
        className="hero-blob-fast absolute top-40 right-0 w-96 h-96 rounded-full bg-accent/40 blur-3xl"
      />
      <div
        aria-hidden
        className="hero-blob-slow absolute bottom-0 left-1/3 w-64 h-64 rounded-full bg-primary/10 blur-2xl"
      />

      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
        <Badge className="hero-el mb-6" variant="secondary">
          New · Real-time pipelines
        </Badge>
        ...
        <p className="hero-el mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl">
          Lumex turns billions of events into instantly queryable insight — without the warehouse
          tax.
        </p>
