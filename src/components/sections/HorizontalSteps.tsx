...
const STEPS = [
  {
    n: "01",
    title: "Connect",
    desc: "Plug into Postgres, Snowflake, BigQuery or stream events directly via SDK.",
  },
  {
    n: "02",
    title: "Model",
    desc: "Define metrics once. Lumex generates a semantic layer your whole team can trust.",
  },
  {
    n: "03",
    title: "Explore",
    desc: "Ask questions in natural language or build pixel-perfect dashboards in minutes.",
  },
];
  ...
  return (
    <section ref={sectionRef} className="bg-secondary/40 overflow-hidden">
      <div className="h-screen flex items-center relative">
        <div ref={trackRef} className="flex h-full will-change-transform" style={{ width: "300%" }}>
          {STEPS.map((s) => (
